...
JNIEXPORT void Java_org_telegraph_messenger_Utilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int radius, int unpin) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void Java_org_telegraph_messenger_Utilities_calcCDT(JNIEnv *env, jclass class, jobject hsvBuffer, int width, int height, jobject buffer) {
...
JNIEXPORT int Java_org_telegraph_messenger_Utilities_pinBitmap(JNIEnv *env, jclass class, jobject bitmap) {
    unsigned char *pixels;
    return AndroidBitmap_lockPixels(env, bitmap, &pixels) >= 0 ? 1 : 0;
}

JNIEXPORT void Java_org_telegraph_messenger_Utilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jobject bitmap, int scale, int width, int height, int stride) {
...
JNIEXPORT jobject Java_org_telegraph_messenger_Utilities_loadWebpImage(JNIEnv *env, jclass class, jobject buffer, int len, jobject options) {
    if (!buffer) {
